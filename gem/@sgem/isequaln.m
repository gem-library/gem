...
%
% example : isequaln(sgem([1 NaN]), sgem([1 NaN])) gives 1
function result = isequaln(varargin)
    ...
    if length(varargin) < 2
        error('Wrong number of arguments in sgem::isequaln');
    end
...
%     end
    ...
    objId2 = varargin{2}.objectIdentifier;
    result = logical(sgem_mex('identicalValuesNaNok', objId1, objId2));
end
