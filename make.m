...
if useSharedGmpAndMpfr == 1
    ...
    if genericBuild == 1
        ...
        if isOctave
            ...
            resultCode(6) = unix(['g++ -Wl,--no-undefined -fstack-protector-strong -Wl,-z,relro -shared src/gem_mex.o src/gem.o src/sgem.o src/utils.o -lmpfr -lgmp -L', matlabroot, '/lib/octave/', version, ' -L/usr/lib/x86_64-linux-gnu -loctinterp -loctave -lstdc++ ', flags, ' -DEIGEN_NO_DEBUG -o gem/gem_mex.', mexext]);
            resultCode(7) = unix(['g++ -Wl,--no-undefined -fstack-protector-strong -Wl,-z,relro -shared src/sgem_mex.o src/sgem.o src/gem.o src/utils.o -lmpfr -lgmp -L', matlabroot, '/lib/octave/', version, ' -L/usr/lib/x86_64-linux-gnu -loctinterp -loctave -lstdc++ ', flags, ' -DEIGEN_NO_DEBUG -o gem/sgem_mex.', mexext]);
        else
