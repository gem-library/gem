function Ms = generateMultipleMatrices(n, maxDim, type, nbDuplicates)
% function Ms = generateMultipleMatrices([n], [maxDim], [type], [nbDuplicates])
%
...
%
% nbDuplicates tells how many matrices of each size should be produces
% 
% Example: generateMultipleMatrices(2, [2 2], {'RS', 'I'}, 3) puts together
